        ...
        <div className="overflow-x-hidden grid grid-cols-1 gap-x-1 mx-3 lg:mt-8 font-copperplate lg:grid-cols-6 justify-end h-screen">
          ...
          <div className="text-[black] lg:order-1 ml-2 col-span-2 lg:px-0 px-8">
            ...
            {headlines1.map((headline, index) => (
              <div
                onClick={() => handleOnClick(headline)}
                style={{
                ...
                key={index + headline}
                className="cursor-pointer hover:bg-gradient-to-r from-orange-100 to-orange-200 rounded-2xl p-2 text-[black] animate__animated animate__backInLeft"
              >
                {headline}
          ...
          <div className="text-[black] lg:text-right lg:order-3 col-span-2 mx-3 lg:px-0 lg:ml-0 ml-2 px-8">
            {headlines2.map((headline, index) => (
              <div
                ...
                key={index + headline}
                className="cursor-pointer hover:bg-gradient-to-r from-orange-100 to-orange-200 rounded-2xl p-2 text-[black] animate__animated animate__backInRight"
              >
                {headline}
                <hr className="h-px my-8 border-0 bg-[#E6E6E6]" />
              </div>
          ...
          {isMobile() && (
            <div className="flex flex-col items-center justify-center p-4 col-span-2 text-[20px] xms:text-[22px] lg:text-[22px]">
              <div className="text-center font-courierPrime mb-4">
                Choose your pffts
              </div>
              <div className="text-center font-courierPrime mb-4">or</div>
              <button
                onClick={handleRePFFT}
                className="mt-0 mb-6 rounded-3xl bg-gradient-to-r from-orange-100 to-orange-200 w-[13rem] h-[3.8rem] font-courierPrime font-bold text-white"
              >
                re-pfft
              </button>
            </div>
