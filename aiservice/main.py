...
def generate_text(prompt: str, engine="ft:davinci-002:ai100::8h721I19", max_tokens: int = 124, stop: Optional[str] = None, temperature: float = 0.6) -> str:
...
def check_and_retry(prompt: str, engine="ft:davinci-002:ai100::8h721I19", temperature: float = 0.6) -> str:
