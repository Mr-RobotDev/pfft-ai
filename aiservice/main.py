...
def generate_text(prompt: str, engine="davinci:ft-ai100-2023-10-13-07-14-13", max_tokens: int = 74, stop: Optional[str] = None, temperature: float = 0.8) -> str:
...
def check_and_retry(prompt: str, engine="davinci:ft-ai100-2023-10-13-07-14-13") -> str:
