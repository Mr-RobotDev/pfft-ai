...
def generate_text(prompt: str, engine="davinci:ft-ai100-2023-12-10-00-52-06", max_tokens: int = 74, stop: Optional[str] = None, temperature: float = 0.7) -> str:
    response = openai.Completion.create(
        engine=engine,
        prompt="The following is a professional satire writing tool. It translates an opinion into a satirical news headline applying one or more humor techniques such as irony, exaggeration, wordplay, reversal, shock, hyperbole, incongruity, benign violation, madcap, unexpected endings, character, reference, non sequitur, brevity, parody, rhythm, analogy, and/or misplaced focus and outputs a hilarious satirical headline. Begin: " + prompt + "->",
