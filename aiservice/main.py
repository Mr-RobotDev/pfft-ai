...
def process_opinion(opinion: str, processing_count: int) -> str:
    ...
    if mod_value == 0:
        prompt = "INSTRUCTIONS: take the opposite of the opinion and justify it hyperbolically ironically with a specific detail or two in one short sentence. Output one SHORT sentence, then add: ###. OPINION: " + opinion + "\nOUTPUT:"
    elif mod_value == 1:
        prompt = "INSTRUCTIONS: take the input opinion and justify it hyperbolically with a specific detail or two in one short sentence. Output one short sentence, then add: ###. OPINION: " + opinion + "\nOUTPUT:"
    elif mod_value == 2:
        prompt = "INSTRUCTIONS: take the opposite of the opinion and justify it hyperbolically ironically with a specific detail or two in one short sentence. Output one short sentence, then add ###. OPINION: " + opinion + "\nOUTPUT:"
    elif mod_value == 3:
        prompt = "INSTRUCTIONS: take the input opinion and justify it hyperbolically with a specific detail or two in one short sentence. Output one SHORT sentence, then add ###. OPINION: " + opinion + "\nOUTPUT:"
