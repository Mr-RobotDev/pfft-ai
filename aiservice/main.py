...
def generate_text(prompt: str, engine="davinci:ft-ai100-2023-05-01-15-06-08", max_tokens: int = 74, stop: Optional[str] = None, temperature: float = 0.7) -> str:
...
def check_and_retry(prompt: str, engine="davinci:ft-ai100-2023-05-01-15-06-08") -> str:
...
def generate_headline():
    try:
        ...
        for i in range(7):
            ...
            prompt = f"{processed_opinion} ->"
            result = check_and_retry(prompt, engine="davinci:ft-ai100-2023-05-01-15-06-08")
            # rest of the code
